...
namespace F8Framework.Core
{
    public static class ModuleCenter
    {
        ...
        private static List<ModuleWrapper> _coms = new(100);
        private static List<ModuleWrapper> _comsUpdate = new(100);
        private static List<ModuleWrapper> _comsLateUpdate = new(100);
        private static List<ModuleWrapper> _comsFixedUpdate = new(100);
